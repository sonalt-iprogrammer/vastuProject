            ...
            <div className="card-body">
              <div className="row RowInside">
                <div className="col-auto">
                  <img className="img-fluid" src="assets/images/stock-photo-chiang-mai-thailand-dec-a-man-holds-apple-iphone-with-ios-compass-application-on-the-354697493 1.png" />
                </div>
                <div className="col">
        ...
        <div className="col-sm-6">
          <div className="card" onClick={onCardTwoClickHandler}>
            <div className="card-body">
              <div className="row ">
                <div className="col-auto">
                  <img  className="img-fluid" src="assets/images/stock-photo-house-object-and-colorful-wooden-blocks-with-direction-initial-alphabet-1789893335 1.png" />
                </div>
                <div  className="col">
